...
/*
Package hello_world is a generated twirp stub package.
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "hello_world")
...
const HelloWorldPathPrefix = "/twirp/hello_world.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/hello_world.HelloWorld/Hello":
