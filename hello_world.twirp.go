...
/*
Package twirpt is a generated twirp stub package.
...
func (c *helloWorldProtobufClient) Hello(ctx context.Context, in *HelloReq) (*HelloResp, error) {
	ctx = ctxsetters.WithPackageName(ctx, "twirpt")
...
const HelloWorldPathPrefix = "/twirp/twirpt.HelloWorld/"
...
func (s *helloWorldServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/twirpt.HelloWorld/Hello":
